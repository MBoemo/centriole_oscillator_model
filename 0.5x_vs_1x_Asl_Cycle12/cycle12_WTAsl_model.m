...
%rescalingFactor = 4.957411513619080e-04;%computed from cycle 12
x_discrete = 0:0.1:449;
rescalingFactor = 1/max(b_10Sol(x_discrete) + b_9Sol(x_discrete) + b_8Sol(x_discrete) + b_7Sol(x_discrete) + b_6Sol(x_discrete) + b_5Sol(x_discrete) + b_4Sol(x_discrete) + b_3Sol(x_discrete) + b_2Sol(x_discrete) + b_1Sol(x_discrete));
fplot(rescalingFactor*(b_10Sol(x) + b_9Sol(x) + b_8Sol(x) + b_7Sol(x) + b_6Sol(x) + b_5Sol(x) + b_4Sol(x) + b_3Sol(x) + b_2Sol(x) + b_1Sol(x)),[0,449]);